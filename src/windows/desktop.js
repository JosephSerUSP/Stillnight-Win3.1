    ...
    constructor() {
        ...
        UI.build(this.header, {
            ...
            children: [
                ...
                { type: 'button', props: { id: 'btn-tuneup', className: 'win-btn', label: 'Tune-up', style: { fontSize: '10px', padding: '0 6px' } } }
            ]
        });

        this.btnFormation = this.header.querySelector("#btn-formation");
        this.btnInventory = this.header.querySelector("#btn-inventory");
        this.btnTuneUp = this.header.querySelector("#btn-tuneup");
...
export class Window_Desktop extends Window_Base {
    ...
    get btnTuneUp() { return this.partyPanel.btnTuneUp; }
