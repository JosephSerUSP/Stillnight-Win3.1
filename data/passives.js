 ...
 * Passives are now containers of traits.
 */
 ...
 * @property {Array<Object>} traits - List of traits granted by this passive.
 */
...
export const passives = {
    ...
    battleStartDamage: {
        ...
        icon: 1,
        traits: [
            { code: 'BATTLE_START_DAMAGE', value: 2 }
        ]
    },
    moveHeal: {
        id: 'moveHeal',
    ...
    recoveryXpBonus: {
        ...
        icon: 1,
        traits: [
             { code: 'RECOVERY_XP_BONUS', value: 5 }
        ]
    },
    fleeChanceBonus: {
        id: 'fleeChanceBonus',
        ...
        icon: 1,
        traits: [
            { code: 'FLEE_CHANCE_BONUS', value: 0.1 }
        ]
    },
    dealDamageMod: {
        id: 'dealDamageMod',
