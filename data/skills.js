...
export const skills = {
    ...
    windBlade: {
        ...
        target: 'enemy-any',
        element: 'Green',
        description: "Strikes a foe with a blade of wind. (DMG: 5 + 1.2 * Lvl)",
        effects: [
    ...
    soothingMote: {
        ...
        target: 'ally-any',
        element: 'White',
        description: "Heals a small amount of HP for an ally. (Heal: 4 + 1.5 * Lvl)",
        effects: [
    ...
    boneRush: {
        ...
        target: 'enemy-any',
        element: 'Black',
        description: "A reckless charge. (DMG: 6 + 1.1 * Lvl)",
        effects: [
    ...
    holySmite: {
        ...
        target: 'enemy-any',
        element: 'White',
        description: "Smite evil with holy light. (DMG: 5 + 1.4 * Lvl)",
        effects: [
    ...
    shadowClaw: {
        ...
        target: 'enemy-any',
        element: 'Black',
        description: "Tears at the enemy from the shadows. (DMG: 6 + 1.3 * Lvl)",
        effects: [
